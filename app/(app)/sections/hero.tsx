    ...
    <div className="md:h-[70vh] border-b mt-12 ">
      <div className="w-full h-full md:grid md:grid-cols-2 ">
        ...
        <div className="h-full flex flex-col justify-center space-y-2 border-l border-l-zinc-300 md:pl-12 p-12">
          ...
          <p className="text-7xl font-black uppercase pt-2">
            for only{" "}
            <span
              className="px-4 text-white"
              style={{ background: mainProduct.color, borderRadius: 120 }}
            >
              {mainProduct.price}$
            </span>
          </p>
          <Button size={"lg"} className="w-fit flex items-center gap-2 rounded-full">
            <span>Buy now </span>
            <IoArrowForward />
          </Button>
        </div>
